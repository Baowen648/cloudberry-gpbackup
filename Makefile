...
BACKUP_VERSION_STR=github.com/apache/cloudberry-gpbackup/backup.version=$(VERSION)
RESTORE_VERSION_STR=github.com/apache/cloudberry-gpbackup/restore.version=$(VERSION)
HELPER_VERSION_STR=github.com/apache/cloudberry-gpbackup/helper.version=$(VERSION)
